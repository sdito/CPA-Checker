...
//  cpaChecker
//
//  Created by Steven Dito on 6/10/19.
...
struct Colors {
    ...
    static let lightGreen = UIColor(red: 58.0/255.0, green: 130.0/255.0, blue: 62.0/255.0, alpha: 1.0)
    
    static let main = UIColor(red: 0.0/255.0, green: 255.0/255.0, blue: 148.0/255.0, alpha: 1.0)
}
